...
console.log('%c Theme.Shoka v' + CONFIG.version + ' %c 此博客主題來源於https://shoka.lostyu.me/ ', 'color: white; background: #e9546b; padding:5px 0;', 'padding:4px;border:1px solid #e9546b;')
console.log('%c balabala，把你變成豬！\n ∧＿∧\n（｡･ω･｡)つ━☆・*。\n⊂   ノ    ・゜+.\nしーＪ　　　°。+ *´¨)\n.· ´¸.·*´¨) ¸.·*¨)\n(¸.·´ (¸.·’*', 'padding: 10px 0;')
console.log('%c 你在看什麽！(* ￣︿￣)~~~din','color: white; background: #e9546b; padding:5px 0;',"\n\n\n算啦，你看吧v(。>︿<)_θ")
